        ...
        <Row>
          ...
          <Col xl={6} lg={6}>
            <div className="introduction__right">
              ...
              മഹാത്മ NGO ഒരു നോൺ പ്രോഫിറ്റ് ഓർഗനൈസേഷനാണ്. വിദ്യാഭ്യാസം, സാമൂഹ്യ ക്ഷേമം, പരിസ്ഥിതി സംരക്ഷണം, ഗുണനിലവാരമുള്ള തൊഴിലവസരങ്ങൾ സൃഷ്ടിക്കൽ എന്നിവയെ പ്രോത്സാഹിപ്പിക്കുന്നതിനായി പ്രവർത്തിക്കുന്ന കൂട്ടായ്മയാണ്.
              </p>
