                  ...
                  <li>
                    ...
                    <div className="text">
                      <p>
                        ...
                        <a href={`mailto:$mahathma.ngo@gmail.com
`}>mahathma.ngo@gmail.com
</a>
                      </p>
                    </div>
                  </li>
              ...
              <div className="site-footer__bottom-inner">
                <div className="site-footer__bottom-logo-social">
                  <div className="site-footer__bottom-logo">
                    <Link href="/">
                      <a>
                        <Image width={200} src={bottomLogo} alt="" />
                      </a>
                    </Link>
                  </div>
